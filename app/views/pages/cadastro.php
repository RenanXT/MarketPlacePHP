...
<div class="d-flex flex-row justify-content-start align-items-start w-100 vh-100">
    ...
    <div class="d-flex flex-column bg-content border border-secondary rounded-2 w-40 h-75 p-3 m-auto
                    align-items-end">
        <form name="idForm" class="d-flex flex-column gap-3 h-100 w-90" method="POST" action="">
            ...
            <div class="d-flex flex-column gap-2 w-100 h-100 overflow-auto">
                ...
                <input name="txtSobrenome" type="text" required
                ...
                <input name="txtCPF" type="text" class="form-control text-light bg-transparent rounded-2 w-75" required>

                <label class="text-light fw-bold">Data de Nascimento:</label>
                <input name="txtNascimento" type="date" required
                       class="form-control text-light bg-transparent rounded-2 w-75">
            ...
            <button type="submit" name="btnCriarConta" class="btn btn-transparent border-light w-50 mt-5 mb-2">Entrar</button>
        </form>
